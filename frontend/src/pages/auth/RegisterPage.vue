<template>
  <div class="flex flex-col">
    ...
    <div class="flex gap-4 mb-6">
      <button class="flex-1 flex justify-center items-center gap-2 py-3 bg-surface-container-lowest ring-1 ring-outline-variant/20 rounded-2xl text-on-surface font-medium hover:bg-surface-container-low transition-colors duration-200" type="button">
